...
# Kestówv 0.5.0 — runtime/binary_classifier.rb
#
  ...
  module Runtime
    module BinaryClassifier
      ...
      def self.register_with_boot
        Boot.register(:runtime_binary_classifier)
        Boot.set_bit(:runtime_binary_classifier)
        self
      end
      ...
      def self.classify_elf(header)
        ...
        Kestowv::Runtime.binary_meta(kind,
          confidence:      0.97,
          arch:            arch,
          endian:          endian,
      ...
      def self.classify_bytecode(kind, header, path)
        ...
        when :jvm_bytecode
          ...
          Kestowv::Runtime.binary_meta(:jvm_bytecode,
            confidence: 0.97,
            metadata: {
        ...
        when :yarv_bytecode
          ...
          Kestowv::Runtime.binary_meta(:yarv_bytecode,
            confidence: 0.95,
            metadata: {
        ...
        when :spinel_artifact
          ...
          Kestowv::Runtime.binary_meta(:spinel_artifact,
            confidence:  0.99,
            verified:    true,
            entry_point: entry_point,
            metadata: {
      ...
      def self.classify_script(header, path)
        ...
        Kestowv::Runtime.binary_meta(:script,
          confidence:  0.95,
          interpreter: interp,
      ...
      def self.classify_flat(header, path)
        ...
        Kestowv::Runtime.binary_meta(:flat_binary,
          confidence: 0.60,
          metadata: {
            load_addr: 0x0,
            size:      size
...
Kestowv::Config::Modules.register(
  :runtime_binary_classifier,
  __FILE__,
  feature:    :binary_classifier,
  depends_on: [:runtime_binary_meta]
)
